...
const formData23 = {
    ...
    return (
        ...
        <div className="gradingApplication">
                    ...
                    <form className='gradingPart'>
                        ...
                        <div className="sections">
                            ...
                            <div className="sub-section grade-value">
                                <label><strong>Grade Vision Section (Max of 20)</strong></label>
                                <input type="text" placeholder = "Enter your Score" id = "vision" onChange={handleGradeChange}  value = {score.vision} />
                            </div>
                ...
                <div className="sectors">
                    ...
                    <form className='gradingPart'>
                        ...
                        <div className="sections">
                            ...
                            <div className="sub-section grade-value">
                                <label><strong>Grade Proposition Section (Max of 20)</strong></label>
                                <input type="text" placeholder = "Enter your Score" id = "proposition" onChange={handleGradeChange}  value = {score.proposition} />
                            </div>
                ...
                <div className="sectors">
                    ...
                    <form className='gradingPart'>
                        ...
                        <div className="sections">
                            ...
                            <div className="sub-section grade-value">
                                <label><strong>Grade Organization Section (Max of 20)</strong></label>
                                <input type="text" placeholder = "Enter your Score" id = "organization" onChange={handleGradeChange}  value = {score.organization} />
                            </div>
                ...
                <div className="sectors">
                    ...
                    <form className='gradingPart'>
                        ...
                        <div className="sections">
                            ...
                            <div className="sub-section grade-value">
                                <label><strong>Grade Economics Section (Max of 20)</strong></label>
                                <input type="text" placeholder = "Enter your Score" id = "economics" onChange={handleGradeChange}  value = {score.economics} />
                            </div>
                    ...
                    <form className='gradingPart'>
                        ...
                        <div className="sections">
                            ...
                            <div className="sub-section grade-value" id='mile' >
                                <label><strong>Grade Milestones Section (Max of 20)</strong></label>
                                <input type="text" placeholder = "Enter your Score" id = "milestones" onChange={handleGradeChange}  value = {score.milestones} />
                            </div>
            ...
            {
                !score.milestones || !score.economics || !score.organization || !score.vision || !score.proposition === "" ? (
